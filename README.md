...
| [XP03](experiments/xp03_drift/) | Drift harness + degradation | ✅ done | glare → misses everything (recall 0.94→0.01); blobs → mild misses; streaks → false alarms (specificity 0.80→0.23) |
